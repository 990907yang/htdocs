				...
				<div class="right_con">	
					...
					<tbody>
                       <?php
                        ...
                        <tr>
							<td>
								<div class="in"><?=$ro['idx']?></div>
							</td>
							<td class="con">
								<div class="in"><a href="/view.php?idx=<?=$ro['idx']?>"><?=$ro['title']?></a></div>
							</td>
							<td>
								<div class="in">
									<div class="in"><?=$ro['date']?></div>
								</div>
							</td>
							<td>
								<div class="in">
									<div class="in"><?=$ro['count']?></div>
								</div>
							</td>
                        </tr>
                        <?php
					...
					<div class="btn_wrap"><p class="write"><a href="write.php">글쓰기</a></p>
					</div>
				</div>
			</div>	
		</div>	
