...
$sql = "insert into member set name='{$_POST["name"]}',year='{$_POST['year']}',month='{$_POST['month']}',day='{$_POST['day']}',id='{$_POST['id']}',password='{$_POST['password']}',pnum='{$phone}',ok='{$_POST['ok']}',email='{$_POST['email']}',add_num='{$_POST['add_num']}',address='{$address}'";
